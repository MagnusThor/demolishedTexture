var ShaderBase = (function () {
    ...
    ShaderBase.prototype.normalize = function (a) {
        var l = this.length(a);
        if (l != 0) {
            a[0] /= l;
            a[1] /= l;
    ...
    ShaderBase.prototype.fade = function (t) {
        return t * t * t * (t * (t * 6 - 15) + 10);
    };
    ShaderBase.prototype.lerp = function (t, a, b) { return a + t * (b - a); };
    ShaderBase.prototype.grad = function (hash, x, y, z) {
        var h = hash & 15;
        var u = h < 8 ? x : y, v = h < 4 ? y : h == 12 || h == 14 ? x : z;
        return ((h & 1) == 0 ? u : -u) + ((h & 2) == 0 ? v : -v);
    };
    ShaderBase.prototype.scale = function (n) { return (1 + n) / 2; };
    ShaderBase.prototype.seed = function (n) {
        var p = [];
        for (var a = [], b = 0; n >= b; b++)
            a.push(b);
        for (b = 0; n >= b; b++) {
    ...
    ShaderBase.prototype.noise = function (x, y, z) {
        var t = this;
        var p = this.perm;
